        ...
        <div className="footer-main">
          <div className="footer-brand">
            <a href="#home" className="footer-logo">
              <span className="logo-bracket">&lt;</span>Harshini<span className="logo-bracket">/&gt;</span>
            </a>
            <p>Aspiring engineer building real-world solutions with Python, IoT, and Web Technologies.</p>
          </div>
          ...
          <div className="footer-social-col">
            ...
            <p className="footer-email">harshinidevinakka@gmail.com</p>
          </div>
        </div>
        <div className="footer-bottom">
          <p>© {year} Harshini Devi Nakka — Built with ❤️ using React.js</p>
